...
REMARKS = {
    "PASS": [
        "AutoSpect AI has inspected the vehicle using advanced visual analysis across multiple views. No visible exterior or structural defects were detected. The vehicle appears to be in excellent condition.",
...
def generate_report(defects: list, image_paths: list, output_path: str, vehicle_info: dict = None):
    ...
    story.append(Paragraph("<b>AutoSpect</b>", title_style))
    story.append(Paragraph("AI-Powered Vehicle Inspection Report", subtitle_style))
    ...
    # Disclaimer with AutoSpect branding
    ...
    story.append(Paragraph(
        "<i>Note: This report was generated by AutoSpect using AI-powered computer vision technology. "
